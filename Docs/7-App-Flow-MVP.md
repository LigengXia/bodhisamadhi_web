...
| R3 | **Members-only locked cards** (App Flow B16, design system §4.2, backend §13.4) | Not rendered in the MVP. Admin form offers Public only; listings filter to `visibility='public'`. The lock-card behaviour is correct and activates in Phase 13. Schema and RLS unchanged. |
