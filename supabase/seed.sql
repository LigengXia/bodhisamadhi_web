...
-- ⚠ Only Aza Rinpoche has a real portrait in Media/. Geshe-la's and Gazi
--   Rinpoche's photos are still needed (Docs/6 §9 open item 3) — their cards
--   fall back to the §3.17 neutral avatar until then.
insert into public.teachers (slug, honorific, name, bio, photo_url, display_order, is_active) values
(
  'geshe-sonam-topgyal',
  'Venerable',
